...
class UOp:
  ...
  @staticmethod
  def load(*args, **kwargs): return UOp(UOps.LOAD, kwargs.pop("dtype", None), tuple(args)+tuple(kwargs.values()))
  @staticmethod
  def store(*args, **kwargs): return UOp(UOps.STORE, kwargs.pop("dtype", None), tuple(args)+tuple(kwargs.values()))
  @staticmethod

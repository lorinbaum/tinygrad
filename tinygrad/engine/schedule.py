...
SCHEDULES: List = []
def create_schedule_with_vars(outs:List[LazyBuffer], _:Optional[Set[LazyBuffer]]=None) -> Tuple[List[ScheduleItem], Dict[Variable, int]]:
  ...
  while queue:
    ...
    for buf in ps.outputs: del buf.srcs
